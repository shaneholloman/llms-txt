...
But there is another very exciting library --- [pysym2md](https://github.com/AnswerDotAI/pysym2md) --- that will allow us to add even more useful information in an automated way.
...
```
dev_requirements = pysym2md llms-txt
```
